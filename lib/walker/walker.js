...
var Walker = elf.Object.clone(function () {
  ...
  this.init = function () {
    this.matchers = (this.matchers || Matchers.clone());
    this.matchers.extend(this.matchers.clone());
  ...
  this.extended = function (extendee) {
    extendee.matchers.extend(this.matchers);
  }

  this.extend = function (obj) {
    var walkers = [].slice.call(arguments);
    walkers.forEach(function (walker) {
      this.matchers.extend(walker.matchers.clone())
    }, this);
    // this.matchers.extend(obj.matchers.clone())
    return this;
  }
  ...
  this.visit = function (node, env) {
    ...
    var matcher    = this.matchers[node.value] || this.matchers[node.type] || this.matchers[node.arity] || this.matchers[undefined] || {specific: [], default: { handler: this.error }}
